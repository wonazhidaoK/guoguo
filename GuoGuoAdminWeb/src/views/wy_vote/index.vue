    ...
    <el-table
      ...
      <el-table-column :label="$t('table.actions')" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-show="scope.row.StatusValue=='Processing'" size="mini" type="danger" style="width:80px;" @click="handTp(scope.row.Id)">手动干预</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :visible.sync="dialogPvVisible" title="投票详情">
      <div>
        ...
        <h5 style="border-bottom:1px solid #e8e8e8;padding-bottom:15px;">
          结束时间: {{ voteDetailCon.Deadline }} {{ voteDetailCon.CreateUserName }}
        </h5>
...
import { createvVote, fetchListVote, updateVote, delVote, detailVote, fetchJyList, handFn } from '@/api/wyVote'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        Deadline: [{ required: true, message: '结束时间是必填的', trigger: 'change' }],
