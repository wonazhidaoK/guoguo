<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.vipOwnerId" placeholder="业委会" clearable style="width: 240px" class="filter-item" @change="handleFilter()">
    ...
    <el-table
      ...
      <el-table-column label="职能名称" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.VipOwnerStructureName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="业主名称" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.OwnerCertificationName }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="是否有效" align="center">
        <template slot-scope="scope">
          <!-- 是否无效 false 有效 true 无效 -->
          <el-tag v-show="!scope.row.IsInvalid" type="warning"> 有效 </el-tag>
          <el-tag v-show="scope.row.IsInvalid" type="danger"> 无效 </el-tag>
        </template>
      </el-table-column>
    </el-table>
...
import { fetchList, delVote, detailVote, getTypeList } from '@/api/wyOwner'
