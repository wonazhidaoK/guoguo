  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.actions')" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-show="scope.row.StatusValue == 'NotAccepted'||scope.row.StatusValue == 'Processing'|| scope.row.Aappeal " type="primary" size="mini" @click="handleUpdate(scope.row, scope.row.Id)">处理</el-button>
              ...
              <template slot="description">
                <div class="step-row">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="processing_content">
                    ...
                    <tr v-show="d == 0">
                      <td style="color:#98A6BE">
                        <div class="processing_content_detail" style="float:left;width:70%"><span>{{ tsDd.Description }}</span></div>
                      </td>
                    </tr>
                    <tr v-show="item.Url != ''">
                      <td>
...
import { createNotice, fetchList, handleTs, delTs, detailTs, chakanTs, tsStatusFn, tsBmFn, tsTypeFn } from '@/api/jdbTs'
