<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.readStatus" placeholder="状态" clearable style="width: 90px" class="filter-item" @change="handleFilter()">
    ...
    <el-table
      ...
      <el-table-column label="状态" align="center">
        <template slot-scope="scope">
          ...
          <el-tag v-show="!scope.row.IsRead" type="warning"> 未读 </el-tag>
          <el-tag v-show="scope.row.IsRead" type="danger"> 已读 </el-tag>
        </template>
      </el-table-column>
...
import { fetchListLetter, updateVote, delVote, detailVote } from '@/api/wyLetter'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      fetchListLetter(this.listQuery).then(response => {
