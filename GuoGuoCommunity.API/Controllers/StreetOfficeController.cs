...
namespace GuoGuoCommunity.API.Controllers
{
    ...
    public class StreetOfficeController : ApiController
    {
        ...
        public async Task<ApiResult<GetAllStreetOfficeOuput>> GetAll([FromUri]GetAllStreetOfficeInput input, CancellationToken cancelToken)
        {
            try
            {
                ...
                return new ApiResult<GetAllStreetOfficeOuput>(APIResultCode.Success, new GetAllStreetOfficeOuput
                {
            ...
            {
                return new ApiResult<GetAllStreetOfficeOuput>(APIResultCode.Success_NoB, new GetAllStreetOfficeOuput { }, e.Message);
            }
        }
        ...
        public async Task<ApiResult<List<GetListStreetOfficeOuput>>> GetList([FromUri]GetListStreetOfficeInput input, CancellationToken cancelToken)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(input.Region))
                ...
                return new ApiResult<List<GetListStreetOfficeOuput>>(APIResultCode.Success, data.Select(x => new GetListStreetOfficeOuput
                {
                    Id = x.Id.ToString(),
                    Name = x.Name
                }).ToList());
            ...
            {
                return new ApiResult<List<GetListStreetOfficeOuput>>(APIResultCode.Success_NoB, new List<GetListStreetOfficeOuput> { }, e.Message);
            }
        }
    }
}
